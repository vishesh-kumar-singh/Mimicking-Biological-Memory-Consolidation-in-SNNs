...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="./data", help="Directory with spike data")
    parser.add_argument("--dataset_name", type=str, default="Split-NMNIST", help="Name for results directory")
    parser.add_argument("--is_nmnist", action="store_true", default=True, help="Use NMNISTDatasetWrapper")
