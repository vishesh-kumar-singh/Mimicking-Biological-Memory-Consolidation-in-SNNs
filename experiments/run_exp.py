...
Usage:
------
    python experiments/run_exp.py --runs 5
    python experiments/run_exp.py --runs 5 --python_path /path/to/python
"""
...
def main():
    ...
    for epochs in EPOCHS_LIST:
        ...
        cmd_baseline = f"{python_cmd} experiments/run_baseline.py --runs {args.runs} --epochs {epochs}"
        ...
        for p in PERCENTILES_LIST:
            ...
            cmd_freezing = f"{python_cmd} experiments/run_freezing.py --runs {args.runs} --epochs {epochs} --percentile {p}"
            ...
            cmd_random = f"{python_cmd} experiments/run_random.py --runs {args.runs} --epochs {epochs} --percentile {p}"
            ...
            cmd_index = f"{python_cmd} experiments/run_index.py --runs {args.runs} --epochs {epochs} --percentile {p}"
            ...
            cmd_noscale = f"{python_cmd} experiments/run_noscale.py --runs {args.runs} --epochs {epochs} --percentile {p}"
