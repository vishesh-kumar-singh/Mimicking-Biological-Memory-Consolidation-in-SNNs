...
------
    ...
    python scripts/analyze_energy.py --checkpoint checkpoints/MNIST/seed_42_epochs_3_taskA.pt

    # Analyze across all checkpoints in a directory
    python scripts/analyze_energy.py --checkpoint_dir checkpoints/MNIST/

    # Run fresh inference on test data and collect spike stats  
    python scripts/analyze_energy.py --epochs 3 --percentile 0.8 --seed 42

    # Compare baseline vs freezing energy profile
    python scripts/analyze_energy.py --compare --epochs 3 --percentile 0.8
"""
...
def run_energy_analysis(seed, epochs, percentile, data_dir=DATA_DIR, is_nmnist=False):
    ...
    """
    from scripts.run_freezing import run_experiment, generate_static_mask_and_reset
